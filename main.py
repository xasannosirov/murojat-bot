...
dp.register_message_handler(cmd_appeal, Text(equals="Write an appeal"))
dp.register_message_handler(cmd_appeal, Text(equals="Написать обращение"))
dp.register_message_handler(cmd_appeal, Text(equals="Murojat yozish"))
...
dp.register_message_handler(cmd_my_appeals, Text(equals="My appeals"), state="*")
dp.register_message_handler(cmd_my_appeals, Text(equals="Мои обращения"), state="*")
